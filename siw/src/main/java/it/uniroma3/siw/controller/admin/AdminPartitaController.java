...
public class AdminPartitaController {
    ...
    public AdminPartitaController(PartitaService partitaService, TorneoService torneoService) {
    ...
    // Mostra il form per modificare una partita esistente
    ...
    public String salvaPartita(@ModelAttribute("partita") Partita partita, Model model) {
        ...
        // Se i gol non sono inseriti, 0 di default
